...
CREATE TABLE `Package` (
  ...
  KEY `Package_status_id_fkey` (`status_id`),
  CONSTRAINT `Package_status_id_fkey` FOREIGN KEY (`status_id`) REFERENCES `AvailabilityStatus` (`status_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `Particular` (
  ...
  KEY `Particular_status_id_fkey` (`status_id`),
  CONSTRAINT `Particular_item_id_fkey` FOREIGN KEY (`item_id`) REFERENCES `Inventory` (`item_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `Particular_status_id_fkey` FOREIGN KEY (`status_id`) REFERENCES `AvailabilityStatus` (`status_id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2026-08-30 16:49:07
