                    ...
                    <div className="space-y-0.5">
                      {dayEvents.slice(0, 2).map((ev) => {
                        ...
                        return (
                          <div
                            key={ev.id}
                            className={`truncate rounded-sm px-1 py-0.5 text-xs font-medium leading-tight cursor-pointer hover:opacity-80 ${colors.bg} ${colors.text}`}
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">
          Monthly calendar of your scheduled events across both venues. Holidays and maintenance still appear for availability.
        </p>
      </div>
