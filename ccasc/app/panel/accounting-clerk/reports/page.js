  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="no-print">
        <ReportPageHeader description="Generate a monthly, weekly or yearly list of SCGCC activities for filing and presentation. Every report prints in the official LIST OF SCGCC ACTIVITIES format." />
      </div>
